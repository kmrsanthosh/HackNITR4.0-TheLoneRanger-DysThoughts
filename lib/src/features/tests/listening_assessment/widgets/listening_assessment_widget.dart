...
import '../controller/listening_assessment_controller.dart';




class listening_assessment extends StatefulWidget {
  listening_assessment({Key? key}) : super(key: key);

  @override
  State<listening_assessment> createState() => _listening_assessmentState();
}

class _listening_assessmentState extends State<listening_assessment> {
  // padding constants
  ...
  List audioFileList = [
    ...
    listeningAssessmentQN1,
    listeningAssessmentQN2,
  ];
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(ListeningAssessmentController());
            ...
            children: [
                      ...
                      Flexible(
                        child: Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: horizontalPadding),
                            child: Image(
                              image: AssetImage(tListeningAssessmentCenterImage),
                              height: 300,
                            )
                        ),
                      ),
              ...
              Visibility(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ListeningAssessmentController.instance.verifyAnswer(controller.answer.text.trim());
                        ListeningAssessmentController.instance.submitAnswers();
                        Get.to(Dashboard());
                      },
