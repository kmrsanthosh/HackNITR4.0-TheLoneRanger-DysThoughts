...
import '../../ishihara_assessment/controller/ishihara_assessment_controller.dart';
import '../controller/math_assessment_controller.dart';
...
class math_assessment extends StatefulWidget {
  math_assessment({Key? key}) : super(key: key);

  @override
  State<math_assessment> createState() => _math_assessmentState();
}

class _math_assessmentState extends State<math_assessment> {
  // padding constants
  ...
  List mathQuestionList = [
    "Enter the total number of squares you see in the above given picture",
    "Solve the above given equation",
  ];
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MathAssessmentController());
                    ...
                    children: [
                      Flexible(
                        child: Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: horizontalPadding),
                            child: Image.network(mathImageList[l],
                              height: 300,
                            )
                        ),
                      ),
                ...
                child: SizedBox(
                  ...
                  child: Ink(
                    child: ElevatedButton(
                      onPressed: () {
                        MathAssessmentController.instance.verifyAnswer(controller.answer.text.trim());
                        MathAssessmentController.instance.submitAnswers();
                        Get.to(Dashboard());
                      },
